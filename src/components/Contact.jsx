    ...
    <div className='h-screen flex items-center justify-center bg-gradient-to-b from-black to-gray-700' id="Contact_page">
      <section class="mx-6 dark:bg-gray-900">
        <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
          <h2 class="mb-4 text-4xl text-blue-600 tracking-tight font-extrabold text-center dark:text-white">Contact Me</h2>
          <p class="mb-4 lg:mb-10 font-light text-gray-200 dark:text-gray-200 sm:text-xl">If you need any help or want to contact me to contribute with any project or any idea. You can contact me here.</p>
