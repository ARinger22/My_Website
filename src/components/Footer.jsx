...
export default function Footer() {
    return (
        <footer className="sc-41d73024-0 cYuXaU"><h4> © 2023 Arpit Kumar Gautam</h4><div className="links">
            <a target="_blank" aria-label="Link to my Github" href="https://github.com/TheViking733n" rel="noreferrer">
                <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                    <path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path>
                </svg>
            </a>
            <a target="_blank" aria-label="Link to my Linkedin" href="https://www.linkedin.com/in/anant-prakash-singh-625b21224/" rel="noreferrer">
                <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
            ...
            <a target="_blank" aria-label="Link to contact me on WhatsApp" href="https://api.whatsapp.com/send?phone=918505077040" rel="noreferrer">
            ...
            <a target="_blank" aria-label="Link to contact me on Instagram" href="https://www.instagram.com/anant733n" rel="noreferrer">
                <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                    <rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect>
                    <path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path>
                    <line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
            </a>
            <a target="_blank" aria-label="Link to contact me on Twitter" href="https://twitter.com/anant733n" rel="noreferrer">
                <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
