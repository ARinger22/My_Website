                ...
                <div className="relative flex h-16 items-center justify-between">
                    ...
                    <div>
                        <ContactDiv className="sc-301b97f5-0 gbbQfw">
                            ...
                            <a className='text-white hover:text-blue-400' target="_blank" rel="noreferrer" aria-label="a to my Linkedin" href="https://www.linkedin.com/in/arpit-gautam-00989322a/">
                                <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a className='text-white hover:text-blue-400' target="_blank" rel="noreferrer" aria-label="a to contact me on WhatsApp" href="https://api.whatsapp.com/send?phone=9179630621">
                            ...
                            <a className='text-white hover:text-blue-400' target="_blank" rel="noreferrer" aria-label="a to contact me on Twitter" href="/">
                                <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
