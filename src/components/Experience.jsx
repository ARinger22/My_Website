...
export default function Experience() {
  return (
    <div className='h-5500 flex items-center justify-center bg-gradient-to-b from-black to-gray-700' id="Experience_page">
      <div className='mx-10'>
        <h1 className='flex justify-center text-blue-600 text-5xl font-bold  mt-16' data-aos="fade-up">Experiences</h1>
        <div className='flex-row mt-16 mb-16 hover:bg-gradient-to-r cursor-pointer' data-aos="fade-right" >
        ...
        <Experience2 className='flex-row mt-16 mb-16 cursor-pointer' data-aos="fade-left">
